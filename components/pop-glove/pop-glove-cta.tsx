      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        >
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Link
              href="/waitlist"
              className="inline-flex justify-center bg-orange px-10 py-4 font-sans text-[0.85rem] font-semibold tracking-[0.08em] text-black no-underline transition-opacity duration-200 hover:opacity-85"
            >
              Pre-Order Now
            </Link>
            ...
            <button
              ...
              className="inline-flex cursor-pointer justify-center border border-white/20 bg-transparent px-10 py-4 font-sans text-[0.85rem] font-semibold tracking-[0.08em] text-white transition-all duration-200 hover:border-white/50 hover:bg-white/5"
            >
