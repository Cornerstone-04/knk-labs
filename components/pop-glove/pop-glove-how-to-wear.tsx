    ...
    <section className="border-b border-border px-6 py-24 md:px-12 md:py-32">
      <div className="mx-auto max-w-7xl">
        ...
        <motion.div
          ...
          className="mb-16 md:mb-24 border-b border-border pb-16"
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
              ...
              <motion.div
                ...
                className="group relative flex aspect-7/6 xl:aspect-video items-center justify-center overflow-hidden border border-border bg-surface"
              >
                <video
                  src="/videos/pop-royal-detail.mp4"
                  loop
                  muted
                  autoPlay
                  playsInline
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            {howToWear.dockingSteps.map((step, idx) => (
              <motion.div
                ...
                className="group border border-border bg-surface/50 p-4 md:p-6 lg:p-8 transition-all ease-linear hover:bg-surface hover:border-white/20"
              >
                <div className="mb-6 flex items-baseline justify-between">
                  <span className="font-heading text-[clamp(2.5rem,8vw,3.5rem)] font-black tracking-[-0.02em] text-orange/30 transition-all ease-linear group-hover:text-orange">
                    {step.number}
                  </span>
                </div>
