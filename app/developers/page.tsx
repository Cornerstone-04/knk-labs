      ...
      <section className="border-b border-border px-6 py-24 md:px-12">
        <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <h2 className="font-heading font-black text-[clamp(2rem,4vw,3rem)] text-white mb-6">
              {developers.headline}
            </h2>
          ...
          <div className="border-t border-border">
            {developers.tools.map((tool, i) => (
              <motion.div
                ...
                className="group grid grid-cols-1 md:grid-cols-[280px_1fr] border-b border-border py-6 hover:bg-bg/50 transition-colors duration-200 cursor-pointer"
              >
                <span className="font-heading font-bold text-[1.1rem] text-white mb-2 md:mb-0 group-hover:text-orange transition-colors duration-200">
                  {tool.label}
                </span>
                <span className="font-sans text-[0.88rem] text-white/50 leading-relaxed">
                  {tool.desc}
                </span>
              </motion.div>
            ))}
      ...
      <section className="border-b border-border px-6 py-24 md:px-12">
        <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h3 className="font-heading font-black text-[2rem] text-white mb-6">
              Get Notified First
            </h3>
