...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "P.O.P Glove",
    "Pop Glove",
    "how to wear Pop Glove",
    "Pop Glove experience",
  ],
  authors: [
    { name: "Keniye Koroye", url: "https://www.koroye.com/" },
    { name: "Ken Nwadiogbu", url: "https://www.kennwadiogbu.com/" },
    { name: "Keniye Koroye", url: "https://cornerstoneephraim.vercel.app" },
  ],
  creator: "Cornerstone Ephraim",
  openGraph: {
    type: "website",
